...
function partOne(filePath) {
    ...
    const seeds = ((_a = text.slice(seedsIndex, seedToSoilIndex).match(/\d+/g)) === null || _a === void 0 ? void 0 : _a.map(Number)) || [];
    ...
    function genMapList(start, end = -1) {
        var _a;
        return ((_a = text.slice(start, end).match(mapReg)) === null || _a === void 0 ? void 0 : _a.map(l => {
    ...
    function mapSourceToDestination(source, mapList) {
        const rlt = mapList.reduce((rlt, map) => {
...
function partTwo(filePath) {
    ...
    const nums = (_a = text.slice(seedsIndex, seedToSoilIndex).match(/\d+/g)) === null || _a === void 0 ? void 0 : _a.map(Number);
    const minLocation = nums === null || nums === void 0 ? void 0 : nums.reduce((minLocation, num, index) => {
        let seed = 0;
        if (index % 2 === 0) {
            seed = num;
